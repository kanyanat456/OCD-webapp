            ...
            <div className="card mb-4">
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    <h2 className="card-title"> การวินิจฉัยระบบด้วย PMQA</h2>
                    <p className="card-text">
                      การพัฒนาคุณภาพการบริหารจัดการภาครัฐในยุคใหม่
                      จะต้องนำเทคโนโลยีดิจิทัล
                      เเละเทคโนโลยีปัญญาประดิษฐ์มาใช้ในการบริหารจัดการองค์การ
                      เพื่อการให้บริการเเก่ประชาชน
                    </p>
                    <a
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <p className="card-text">
                      ...
                      เพื่อการพัฒนาคุณภาพการบริหารภาครัฐในยุคดิจิทันเเละ AI
                    </p>
                    <a
