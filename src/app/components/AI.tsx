        ...
        <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
          ...
          <div className="lg:w-2/3 w-full">
            ...
            <p className="mb-8 leading-relaxed">
              คำชี้เเจง AI ตรวจวินิจฉัยโรคมะเร็งปอด
              <ol style={{ listStyleType: "disc" }} className="ml-4">
                <li>
                  ถ้าผลการพยากรน์เป็น lung_aca หมายความว่าเป็นโรคมะเร็งปอดชิด
                  aca
                </li>
                <li>
                  ถ้าผลการพยากรน์เป็น lung_bnt
                  หมายความว่าเป็นปกติไม่เป็นโรคมะเร็งปอด
                </li>
                <li>
                  ถ้าผลการพยากรน์เป็น lung_scc หมายความว่าเป็นโรคมะเร็งปอดชิด
                  scc
                </li>
              </ol>
            </p>
